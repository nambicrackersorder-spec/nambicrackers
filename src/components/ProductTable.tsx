...
const productImageUrlForTable = (product: Product) => productImageUrl(product);
...
export function ProductTable({
  ...
  const hideImages = Boolean(cat.hideImages) || ["Paper Bombs", "MINI DIGITAL", "MEGA DIGITAL"].includes(cat.name);
