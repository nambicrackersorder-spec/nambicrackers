  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Contact Nambi Crackers Sivakasi" },
      {
        ...
        content:
          "Call, WhatsApp or email Nambi Crackers for your crackers enquiry or Diwali order.",
      },
    ...
    <div className="min-h-screen">
      ...
      <main className="mx-auto max-w-3xl px-4 py-10">
        ...
        <div className="mt-6 grid gap-4 sm:grid-cols-2">
          ...
          >
            ...
            <span>
              ...
              <span className="text-sm text-muted-foreground">{settings.phoneDisplay}</span>
            </span>
          </a>
          <a
        ...
        <div className="mt-6 rounded-xl bg-secondary p-5 text-sm text-muted-foreground">
          Minimum order value is Rs {settings.minOrder.toLocaleString("en-IN")}. Orders are treated as enquiries and confirmed
