  ...
  head: () => ({
    meta: [
      ...
      { property: "og:site_name", content: "Nambi Crackers" },
      {
        ...
        content:
          "Crackers discount at 90% with Sivakasi firework price list and online enquiry ordering.",
      },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Cinzel:wght@600;700&family=Mukta:wght@400;600;700&display=swap",
      },
    ],
  }),
